module AffiliateWindow::Clients
  ...
  class Merchant
    ...
    URL_TEMPLATE = 'https://ui2.awin.com/affiliates/shopwindow/datafeed_metadata.php?user=#{user}&password=#{datafeed_password}&format=#{format}&filter=#{filter}&compression='
